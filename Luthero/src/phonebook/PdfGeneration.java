...
public class PdfGeneration {
    public void pdfGeneration(String fileName, ObservableList<Person> data) {
        ...
        try {
            ...
            document.open();
            Image image1 = com.itextpdf.text.Image.getInstance(getClass().getResource("/logo.jpg"));
            ...
            //Aláírás
            Chunk signature = new Chunk("\n\n Generálva a Luthero alkalmazás segítségével.");
            //c.setBackground(BaseClor.Blue);
